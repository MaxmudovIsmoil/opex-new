          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6 mb-3">
                <RoadSelect v-model="formData.order_type_id" :disabled="isLoading" />
...
export default {
  ...
  setup(props, { emit }) {
    const { modalRef, formData, isLoading, errors, errorMessage, closeModal } = useUserModal(props, emit);
    ...
    const submitForm = async () => {
      ...
      try {
        ...
        const response = await apiClient.post('/admin/user/create', payload);
